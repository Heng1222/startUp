        ...
        fetch('tourist.json')
            ...
            .then(data => {
                ...
                function getColor(value) {
                    if (value >= 3000000) return colorScale[4];
                    if (value >= 1000000) return colorScale[3];
                    if (value >= 400000) return colorScale[2];
                    if (value >= 200000) return colorScale[1];
                    return colorScale[0];
                }
                    ...
                    if (selectedCounty) {
                        ...
                        selectedFeatures.forEach(feature => {
                            ...
                            var marker = L.marker(centroidCoordinates.reverse(), {
                                ...
                                .bindPopup("縣市: " + feature.properties.COUNTY + "<br>人次: " + feature.properties.COLUMN1)
                                .openPopup();
                        });
